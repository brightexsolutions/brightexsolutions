 ...
 *     governing law) are FIXED text in agreement-pdf.tsx, never AI-drafted —
 *     only the commercial specifics (scope/fees/timeline) are AI-assisted.
 * The PDF itself is rendered on demand from the saved `data` — see
...
Draft the content for a Brightex Solutions project proposal, based on this engagement summary from the business owner:
...
Return JSON in exactly this shape:
{
  ...
  "intro": "<2-4 sentence executive summary of the engagement and what the client needs>",
  "scope_items": [{ "title": "<deliverable>", "description": "<1-2 sentences>" }, ... 3-6 items],
  "line_items": [{ "description": "<line item>", "qty": <number>, "unit_price": <number, KES> }, ... amounts must sum sensibly toward the target budget if one was given],
  ...
  "notes": "<optional: anything else worth noting, or omit this field>"
}`;
